...
.config(function($routeProvider,$locationProvider){
    ...
    .when('/room',{
        templateUrl: 'app/views/pages/rooms/room.html',
        controller: 'roomCtrl',
        controllerAs: 'room',
        authenticated: true
    })
    ...
    .when('/addRoom',{
        templateUrl: 'app/views/pages/rooms/addRoom.html',
        controller: 'roomCtrl',
        controllerAs: 'room',
        authenticated: true
    })
    ...
    .when('/roomEdit/:id', {
        templateUrl: 'app/views/pages/rooms/roomEdit.html',
        controller: 'roomEditCtrl',
        controllerAs: 'roomEdit',
        authenticated: true
    })
    .when('/hotelEdit/:id', {
    ...
    .when('/roomSearch', {
        templateUrl: 'app/views/pages/rooms/roomSearch.html',
        controller: 'roomCtrl',
        controllerAs: 'room',
        authenticated: true
    })
